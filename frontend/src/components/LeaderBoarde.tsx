...
const LeaderBoard = (prop: any) => {
	return (
		<>
			<div
				key={prop.index}
				className="flex h-32  w-full mb-5 flex-col gap-2 border border-teal-800  transform transition duration-500 hover:scale-105  bg-white shadow-lg rounded-lg p-2 ">
